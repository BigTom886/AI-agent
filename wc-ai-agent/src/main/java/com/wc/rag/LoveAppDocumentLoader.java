 ...
 *
 * <p>
 * 负责从 classpath:document/ 目录下扫描所有 .md 文件，
 * 使用 Spring AI 提供的 {@link MarkdownDocumentReader} 将每个 Markdown 文件解析为
 * 一个或多个 {@link Document} 对象，供后续 RAG（检索增强生成）流程使用。
 *
 * <p>
